...
const SYMPTOM_RULES: Partial<Record<RepairJobRecord["appliance_type"], SymptomRule[]>> = {
  washing_machine: [
    ...
    { test: /nois|knock|bang|rattl|thump|clunk/i, likely_subsystem: "Drum bearing, suspension, or a foreign object in the drum", candidate_parts: [{ name: "Tub bearing", reason: "A worn tub bearing is the most common cause of a rhythmic knocking or grinding noise, especially during spin." }, { name: "Suspension rods or shock absorbers", reason: "Worn suspension lets the drum strike the cabinet during spin, producing a banging noise." }] },
  ],
  dryer: [
