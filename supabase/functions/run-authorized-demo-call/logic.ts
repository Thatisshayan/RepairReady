...
export const DEMO_TASK = [
  ...
  "If the participant does not know or cannot find the exact model number, do not treat this as a blocker: ask for the brand alone if known, one distinguishing detail such as color, size, or door style, and record that the model still needs on-site verification, then continue with the rest of the call.",
